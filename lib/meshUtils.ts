...
class MeshUtils {
   ...
   */
  public static findMeshByName(scene: BABYLON.Scene, name: string): BABYLON.AbstractMesh | null {
   ...
   */
  public static findMeshesByPattern(scene: BABYLON.Scene, pattern: RegExp): BABYLON.AbstractMesh[] {
   ...
   * @returns The found mesh or null if not found
   */
  public static findNestedMesh(rootMesh: BABYLON.AbstractMesh, targetName: string): BABYLON.AbstractMesh | null {
   ...
   * @param mesh - The mesh to get the material from
   * @returns The material of the mesh or null if no material is assigned
   */
  public static getMaterial(mesh: BABYLON.AbstractMesh): BABYLON.Material | null {
    return mesh.material;
  }

  /**
   * Sets a material to a mesh
   * @param mesh - The mesh to set the material to
   * @param material - The material to assign
   */
  public static setMaterial(mesh: BABYLON.AbstractMesh, material: BABYLON.Material): void {
